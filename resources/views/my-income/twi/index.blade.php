             ...
             <div class="nk-content nk-content-fluid">
                ...
                <div class="container-xl wide-lg">
                    <div class="nk-content-body">
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between g-3">
                                <div class="nk-block-head-content">
                                    <p class="text-danger">You can withdraw 5 % of Total Working income in every Monday</p>
                                    <h3 class="nk-block-title page-title">Level Bonus List</h3>
                                    <div class="nk-block-des text-soft">
                                        <p>Total {{ $workingIncome->total() }} Rows.</p>
                                    </div>
                        ...
                        @if($workingIncome->count()>0)
                           @include('my-income.twi.wallet')  
                        @endif
                                ...
                                <div class="card-inner-group">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h5 class="title">All Level Bonus</h5>
                                            </div>
                                    ...
                                    <div class="card-inner p-0">
                                        <table class="table table-tranx">
                                            ...
                                            <tbody>
                                                @foreach ($workingIncome as $key=>$twi)

                                                <tr class="tb-tnx-item">
                                                    <td class="tb-tnx-id">
                                                        <a href="#"><span>{{$twi->id}}</span></a>
                                                    </td>
                                                    <td class="tb-tnx-info">
                                                        <div class="tb-tnx-desc">
                                                            <span class="title">{{$twi->fromUser->name}}</span>
                                                        </div>
                                                        <div class="tb-tnx-date">
                                                            <span class="date font-weight-bold">{{$twi->referal_amount}}</span>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-sm">
                                                                <ul class="link-list-plain">
                                                                    <li><a href="{{url('admin/levels/'.$twi->id.'/edit')}}">Edit</a></li>
                                    ...
                                    @if($workingIncome->hasPages())
                                    <div class="card-inner">
                                        {{ $workingIncome->withQueryString()->links('pagination::bootstrap-4') }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-lg">
                    <div class="nk-block-head nk-block-head-xs text-center">
                        <h5 class="nk-block-title plan-title">Withdrawal Working Income</h5>
                        <div class="nk-block-text">
                            <div class="caption-text description-sub">Total Token in your wallet  
                                @if(!is_null($loggedInUser->walletInfo))
                                {{$loggedInUser->walletInfo->working_income ?number_format($loggedInUser->walletInfo->working_income,2): 0}}
                                @else
                                0
                                @endif
                            </div>
