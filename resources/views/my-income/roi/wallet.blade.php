            ...
            <div class="nk-wgw">
               <div class="nk-wgw-inner">
                  <a class="nk-wgw-name" href="javascript:void(0)">
                     ...
                     <h5 class="nk-wgw-title title">ROI Income</h5>
                  </a>
                  <div class="nk-wgw-balance">
                     <div class="amount">{{$loggedInUser->walletInfo->non_working_income ?number_format($loggedInUser->walletInfo->non_working_income ,2): 0}}<span class="currency currency-bnb">Cake Verse</span></div>
