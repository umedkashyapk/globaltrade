                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="{{url('/')}}" class="logo-link">
                                    <img class="logo-light logo-img" src="{{asset('assets/images/logo.svg')}}" srcset="{{asset('assets/images/logo.svg')}} 2x" alt="logo">
                                    <img class="logo-dark logo-img" src="{{asset('assets/images/logo.svg')}}" srcset="{{asset('assets/images/logo.svg')}} 2x" alt="logo-dark">
                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status user-status-unverified">{{UserManager::accountStatusName()}}</div>
                                                    <div class="user-name dropdown-indicator">{{UserManager::get()->name}}</div>
                                                </div>
                                            </div>
                                        </a>
