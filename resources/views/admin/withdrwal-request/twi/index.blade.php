         ...
         <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between ">
               <div class="nk-block-head-content">
                  <h3 class="nk-block-title page-title">Twi Withdrawal Request</h3>
                  ...
                  <div class="card-inner">
                     <div class="card-title-group">
                        <div class="card-title">
                           <h5 class="title">All Requests</h5>
                        </div>
                  ...
                  <div class="card-inner p-0 ">
                     <div class="nk-tb-list nk-tb-ulist nk-tb-tnx ">
                        <div class="nk-tb-item nk-tb-head">
                           ...
                           <div class="nk-tb-col tb-col-lg"><span>Withdraw In</span></div>
                        ...
                        <div class="nk-tb-item ">
                           ...
                           <div class="nk-tb-col nk-tb-col-tools">
                              <ul class="nk-tb-actions gx-1">
                                 ...
                                 <li class="nk-tb-action-hidden"><a class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" href="javascript:void(0)" onClick="onApprovedMethod({{$wh->id}},1)" id="YWLX52JG74approve"> <em class="icon ni ni-done"></em></a></li>
                                 <li class="nk-tb-action-hidden"><a class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" id="YWLX52JG74reject" onClick="onApprovedMethod({{$wh->id}},0)"> <em class="icon ni ni-cross-round"></em></a></li>
                                 <li>
                                    <div class="dropdown">
                                       <a aria-haspopup="true" class="dropdown-toggle bg-white btn btn-sm btn-outline-light btn-icon" aria-expanded="false"><em class="icon ni ni-more-h"></em></a>
                                       <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                          <ul class="link-list-opt no-bdr">
                                             <li><a href="javascript:void(0)"  tabindex="0" role="menuitem" class="dropdown-item"><em class="icon ni ni-done"></em><span>Approve</span></a></li>
                                             <li><a href="#reject" tabindex="0" role="menuitem" class="dropdown-item"><em class="icon ni ni-cross-round"></em><span>Reject</span></a></li>
                                             <li><a href="#details" tabindex="0" role="menuitem" class="dropdown-item"><em class="icon ni ni-eye"></em><span>Details</span></a></li>
                                          </ul>
                                       </div>
                                    </div>
                                 </li>
