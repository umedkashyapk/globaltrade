                                    ...
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            ...
                                            {{-- <div class="dropdown-inner user-account-info">
                                                ...
                                                <div class="user-balance">0.0 <small class="currency currency-btc">Metapex</small></div>
                                                <div class="user-balance-sub">Locked <span>0.0 <span class="currency currency-btc">Metapex</span></span></div>
                                                <a href="javascript:void(0)" class="link"><span>Withdraw Funds</span> <em class="icon ni ni-wallet-out"></em></a>
                                            </div> --}}
