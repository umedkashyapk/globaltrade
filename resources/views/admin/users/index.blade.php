                                        ...
                                        <div class="card-inner p-0">
                                            <div class="nk-tb-list nk-tb-ulist">
                                                <div class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <div class="nk-tb-col tb-col-md"><span class="sub-text">KYC Status</span></div>
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-md">
                                                        ...
                                                        @else
                                                        <span class="tb-status text-danger">In-Active</span>
                                                        @endif
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            ...
                                                                            <li><a href="{{url('admin/user-lists/'.$user->id)}}"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
