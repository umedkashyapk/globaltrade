            ...
            <div class="components-preview wide-md mx-auto">
                <div class="nk-block-head nk-block-head-lg wide-sm">
                    <div class="nk-block-head-content">
                        ...
                        <h2 class="nk-block-title fw-normal">Create Plan</h2>
                ...
                <div class="nk-block nk-block-lg">
                    ...
                    <div class="card card-preview">
                        <div class="card-inner">
                            <form class="preview-block form-validate is-alter" method="post" action="{{url('admin/plans')}}" autocomplete="off">
                                @csrf
                                <div class="row gy-4">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="plan_name" value="{{old('plan_name')}}" class="form-control form-control-lg" id="plan_name" placeholder="Plan Name" required>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <textarea  name="plan_desc" value="{{old('plan_desc')}}" class="form-control form-control-lg" id="plan_description" placeholder="Plan Description" required></textarea>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="no_of_months" value="{{old('no_of_months')}}" class="form-control form-control-lg" id="no_of_months" placeholder="No of Months" required>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="monthly_roi" value="{{old('monthly_roi')}}" class="form-control form-control-lg" id="monthly_roi" placeholder="Monthly ROI" required>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" value="{{old('min_joining_token')}}" name="min_joining_token" class="form-control form-control-lg" id="min_joining_token" placeholder="Min Joining Token" required>
                                            </div>
